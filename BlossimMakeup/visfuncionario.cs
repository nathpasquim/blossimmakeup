...
{
    public partial class visfuncionario : Form
    {
        public visfuncionario()
        {
            InitializeComponent();
            ...
            consulta.CommandText = "DESCRIBE funcionario";
            ...
            while (resultado.Read())
            {
                dataGridView1.Rows.Add(
                         ...
                         resultado["salario"].ToString(),
                         resultado["cep"].ToString(),
                         resultado["email"].ToString(),
                         resultado["id"].ToString(),
                         resultado["nome"].ToString(),
                         resultado["numeroCasa"].ToString());
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand consulta = new MySqlCommand();
            consulta.Connection = conectar;
            consulta.CommandText = "SELECT * FROM funcionario WHERE id like '%" + nomecampo + "%'";
